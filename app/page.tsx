      ...
      <section className="section-dark relative overflow-hidden">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
          <FadeIn>
            ...
            <h1 className="brand-caps mt-4 text-3xl font-light leading-tight text-brand-cream md:text-4xl lg:text-5xl">
              {BRAND.chef}
            </h1>
            <div className="gold-rule mt-6" />
            <p className="mt-6 font-body text-lg font-light leading-relaxed text-brand-cream-muted md:text-xl">
              {HERO_SUBHEADLINE}
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <Link href="/private-chef" className="btn-primary-solid">
                Book Private Chef
              </Link>
          ...
          <FadeIn delay={150} className="flex justify-center md:justify-end">
            <div className="relative">
              <div className="h-72 w-72 overflow-hidden rounded-full border-2 border-brand-gold shadow-[0_0_40px_rgba(198,162,101,0.15)] md:h-80 md:w-80">
                <Image
              ...
              <div className="card-dark absolute -bottom-4 -right-2 px-6 py-4 md:-right-4">
            ...
            {SERVICES.map((service, i) => {
              ...
              return (
                <FadeIn key={service.title} delay={i * 80}>
                  <Link
                    href={service.href}
                    className="card-light group block h-full p-6 transition-shadow duration-500 hover:shadow-md"
                  >
                    {inner}
                  </Link>
                </FadeIn>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:gap-6">
            {SIGNATURE_DISHES.map((dish, i) => {
              ...
              return (
                <FadeIn key={dish.title} delay={i * 60}>
                  <Link
                    href={href}
                    className="group relative block aspect-[4/5] overflow-hidden bg-brand-bg"
                  >
                    <Image
                      src={dish.image}
                      alt={dish.title}
                    ...
                    />
                    <figcaption className="absolute inset-0 flex items-end bg-gradient-to-t from-black/85 via-black/20 to-transparent p-4 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
